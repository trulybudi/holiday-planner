...
export default function HolidaysPage() {
  ...
  if (!user) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        <p className="text-gray-600 mb-4">Please login to view your holidays</p>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900">My Holidays</h1>
        <Link
          href="/holidays/new"
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <p className="text-gray-600 mb-4">You haven't created any holidays yet</p>
          <Link href="/holidays/new" className="text-blue-600 hover:underline">
